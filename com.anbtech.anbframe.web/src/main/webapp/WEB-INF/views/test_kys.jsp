...
<h3>김영심 과장 , 윤석완 사원</h3>
    ...
    <div id="toolbar">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">Add User</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editUser()">Edit User</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyUser()">Delete User</a>
    </div>
    ...
    <script type="text/javascript">
        ...
        function newUser(){
            ...
            $('#fm').form('clear');
            url = '${pageContext.request.contextPath }/user_insert_kys.do';
        }
        function editUser(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                //curl = 'update_user.php?id='+row.id;
                url = '${pageContext.request.contextPath }/user_insert_kys.do?id='+row.id;
            }
        }
        function saveUser(){
            $('#fm').form('submit',{
            ...
            if (row){
                $.messager.confirm('삭제확인','선택한 사용자를 삭제하시겠습니까?',function(r){
                    if (r){
                        ...
                        $.post('${pageContext.request.contextPath }/user_delete_kys.do',{userId:row.userId},function(result){
